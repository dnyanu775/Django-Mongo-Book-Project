...
def register(request):
    ...
    if request.method=="POST":
        ...
        obj=BookOperations()
        obj.reguser(fname,lname,uid,psw)
    return render(request,"login.html")
...
def addbook(request):
    if request.method=="POST":
       ...
       obj=BookOperations()
       obj.addnewbook(id,title,genre,author,published_year,isbn,pages,language,publisher)
    return render(request,"Admin.html")
...
def update(request):
    if request.method=='POST':
        ...
        publisher=request.POST.get('publisher')
        obj=BookOperations()
        obj.updatedata(bid,title,author,genre,published_year,isbn,pages,language,publisher)
    return render(request,"Admin.html") 
